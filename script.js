...
let numberLineColor = document.getElementById('line-color').value;
let largeHandColor = document.getElementById('large-hand-color').value;
let secondHandColor = document.getElementById('second-hand-color').value;
  const now = new Date();
